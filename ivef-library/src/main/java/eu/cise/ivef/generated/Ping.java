...
public class Ping implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof Ping) {
            final Ping copy = ((Ping) draftCopy);
            {
